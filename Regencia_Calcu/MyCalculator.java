...
public class MyCalculator extends Frame
{
    ...
    String specialButtonText[] = {"Back spc", "C", "CE" };
    ...
    MyCalculator(String frameText)//constructor
    {
        ...
        displayLabel.setFont(new Font("Souvenir",Font.BOLD, 20));
        add(displayLabel);
        memLabel.setBounds(TOPX, TOPY+HEIGHT+ V_SPACE,WIDTH, HEIGHT);
        add(memLabel);
        
        //Theme
        CheckboxGroup bgcolor = new CheckboxGroup();
        Checkbox light = new Checkbox("Light",bgcolor,true);
        light.setBounds(30,30,60,30);
        Checkbox dark = new Checkbox("Dark",bgcolor,false);
        dark.setBounds(100,30,60,30);
        light.setFont(new Font("Souvenir",Font.BOLD, 15));
        dark.setFont(new Font("Souvenir",Font.BOLD, 15));
        add(light);add(dark);
        ...
        dark.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e){
                ...
                memLabel.setBackground(Color.BLACK);
            }
        });
        //REGENCIA,RHEYMARK B.
        ...
        memoryButton[i].setBackground(darkgrey);
        memoryButton[i].setFont(new Font("Souvenir",Font.BOLD, 20));
        y+=HEIGHT+V_SPACE;
        ...
        {
        specialButton[i]=new MySpecialButton(tempX,y,WIDTH*2+10,HEIGHT,specialButtonText[i], this);
        specialButton[i].setForeground(Color.BLACK);
        specialButton[i].setBackground(lightgrey);
        specialButton[i].setFont(new Font("Souvenir",Font.BOLD, 20));
        ...
        digitButton[i].setBackground(darkgrey);
        digitButton[i].setFont(new Font("Souvenir",Font.BOLD, 20));
        tempX+=WIDTH+H_SPACE;
        ...
        operatorButton[i].setBackground(orange);
        operatorButton[i].setFont(new Font("Souvenir",Font.BOLD, 20));
